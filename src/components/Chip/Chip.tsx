...
const variantColorClasses: Record<Variant, Record<Color, string>> = {
  ...
  gradient: {
    ...
    green:
      "bg-linear-to-tr from-green-600 to-green-500 text-white border border-transparent",
    amber:
      "bg-linear-to-tr from-amber-600 to-amber-500 text-white border border-transparent",
    pink: "bg-linear-to-tr from-pink-600 to-pink-500 text-white border border-transparent",
    indigo:
      "bg-linear-to-tr from-indigo-600 to-indigo-500 text-white border border-transparent",
    purple:
      "bg-linear-to-tr from-purple-600 to-purple-500 text-white border border-transparent",
    ...
    slate:
      "bg-linear-to-tr from-slate-800 to-slate-700 text-white border border-transparent",
...
export default function Chip({
  ...
  const variantClasses =
    variantColorClasses[variant][color] || variantColorClasses.filled.blue;

  return (
    <Badge
      className={cn(
        "animate-fadeIn rounded-md px-2.5 py-1 text-xs font-bold shadow-xs",
        variantClasses,
        className,
      )}
    >
