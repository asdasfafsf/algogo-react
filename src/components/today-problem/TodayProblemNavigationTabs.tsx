        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          {problems.map((problem, index) => (
            <ShadcnButton
              ...
              className={`h-auto min-h-28 whitespace-normal justify-start p-4 rounded-xl border-2 transition-all duration-200 text-left ${
                index === currentIndex
            ...
            >
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <span
                    className={`text-xs font-medium ${index === currentIndex ? "text-white/80" : "text-slate-500"}`}
                  >
                    문제 {index + 1}
                  </span>
