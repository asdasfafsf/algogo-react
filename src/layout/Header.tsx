  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-40 border-b border-border/70 bg-background/85 backdrop-blur-xl">
        <div className="mx-auto grid h-16 max-w-7xl grid-cols-[1fr_auto] items-center gap-6 px-4 sm:px-6 md:grid-cols-[1fr_auto_1fr]">
          <div className="justify-self-start">
            <LogoWithText size="medium" />
          </div>
          <nav
            aria-label="주 메뉴"
            className="hidden h-full justify-self-center md:flex"
          >
