...
const [pageState, notFound, error, errorFallback, my, oauthStatus] =
  await Promise.all([
    fs.readFile(
    ...
    fs.readFile(
      new URL("../src/components/errors/ErrorFallback.tsx", import.meta.url),
      "utf8",
    ),
...
assert.match(errorFallback, /잠시 문제가 생겼어요/);
assert.match(error, /<ErrorFallback/);
